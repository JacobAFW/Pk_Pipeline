...
bcftools view FILTERED_SNPs.vcf | head -n 85 > FILTERED_SNPs_head.vcf 
bcftools view FILTERED_INDELs.vcf | head -n 85 > FILTERED_INDELs_head.vcf 
bcftools view PK_consensus_FILTERED.vcf | head -n 85 > FILTERED_consensus_head.vcf 
...
Hence, grep and tabix.

esnemnble = version 104

need to download cache??????? http://asia.ensembl.org/info/docs/tools/vep/script/vep_cache.html#gff 
cd $HOME/.vep
curl -O http://ftp.ebi.ac.uk/ensemblgenomes/pub/protists/current/variation/vep/plasmodium_knowlesi_vep_51_ASM635v1.tar.gz
tar xzf plasmodium_knowlesi_vep_51_ASM635v1.tar.gz 
