...
bcftools merge --threads 15 --force-samples -o variants_only_test/merged_variants_only.vcf.gz GATK/Genotyped.vcf.gz samtools/PK_samtools_variants_only_header.raw.vcf.gz
...
tail -n +2 vcf_variant_names2.tsv > grep_patterns.txt 
...
Required for variant-specific filtering & bam-preprocessing later on.
...
/usr/local/jdk1.8.0_131/bin/java -Djava.iodir=$PBS_JOBFS -Xms3200m -Xmx3600m -jar /home/jwestaway/pk_pipeline/tools/gatk-4.2.2.0/gatk-package-4.2.2.0-local.jar \
    VariantsToTable \
    -R $INDEXTDIR \
    -V variats_only_test/GVCFall_SNPs.vcf \
...
/usr/local/jdk1.8.0_131/bin/java -Djava.iodir=$PBS_JOBFS -Xms3200m -Xmx3600m -jar /home/jwestaway/pk_pipeline/tools/gatk-4.2.2.0/gatk-package-4.2.2.0-local.jar \
    VariantsToTable \
    -R $INDEXTDIR \
    -V variats_only_test/GVCFall_INDELs.vcf \
    -F CHROM -F POS -F QUAL -F QD -F DP -F MQ -F GQ -F MQRankSum -F FS -F ReadPosRankSum -F SOR \
