...
for i in *_val_1.fq.gz
do
bowtie2 -p 20 -x $INDEXTDIR/HG -1 $i -2 ${i%_1_val_1.fq.gz}_2_val_2.fq.gz | samtools view -u -S - | samtools sort -n -o $OUTDIR/${i%_1_val_1.fq.gz}.bam
done 
