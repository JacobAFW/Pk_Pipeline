...
#### Create VCFs for SNPs/Indels only

For bam pre-processing, there are arguments that require either all known variants or only a single type of variant. 
Thus we need to create additional VCF files that are specific to variant types.
...
Consensus VCF files:
 - PK_consensus_corrected.vcf
 - PK_consensus_corrected_snps.vcf
 - PK_consensus_corrected_indels.vcf
